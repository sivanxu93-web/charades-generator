...
export default async function ClassroomCharadesGuidePage({ params }: PageProps) {
  ...
  return (
    <FlatGeneratorPageLayout
      ...
      structuredDataCategory="Education"
    ...
    >
      ...
      <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">{t.section3Title}</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        {[t.columnA, t.columnB].map((col) => (
          <div key={col.title} className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
