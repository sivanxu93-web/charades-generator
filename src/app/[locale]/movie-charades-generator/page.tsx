...
export default async function MovieCharadesPage({ params }: PageProps) {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-3">{copy.partyTitle}</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        {copy.partyColumns.map((column) => (
          <div key={column.title} className="p-5 rounded-lg shadow-sm border border-gray-100" style={{ backgroundColor: column.background }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
        {copy.categories.map((card) => (
          <div key={card.title} className="text-center p-5 rounded-lg shadow-sm border border-gray-100" style={{ backgroundColor: card.background }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 bg-gradient-to-r from-gray-50 to-blue-50 border border-blue-100 rounded-xl p-6">
        <div>
          <h3 className="text-lg font-bold mb-3" style={{ color: copy.tips.actingHeadingColor }}>
        ...
        <div>
          <h3 className="text-lg font-bold mb-3" style={{ color: copy.tips.guessingHeadingColor }}>
      ...
      <div className="flex flex-wrap gap-2 text-sm mb-8">
        <Link href={buildLocalePath(locale, "/reverse-charades-game/")}
          className="inline-flex items-center rounded-md border border-gray-300 px-3 py-1.5 text-gray-800 hover:bg-gray-100">
