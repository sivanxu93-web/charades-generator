  ...
  generator: {
    ...
    scenarios: [
      ...
      },
      {
        id: "classroom",
        title: "Classroom / ESL",
        description: "Educational and simple verbs for students.",
        category: "actions",
        difficulty: "easy",
        ageGroup: "kids",
        wordCount: 10,
        roundLength: "90s",
        tip: "Divide the class into two large teams.",
      },
      {
        id: "adults",
        title: "Adult Party",
        description: "Hilarious and slightly mature humor.",
        category: "funny",
        difficulty: "medium",
        ageGroup: "adults",
        wordCount: 8,
        roundLength: "60s",
        tip: "Perfect for office socials or dinner parties.",
      },
      {
        id: "lightning",
        title: "Lightning Round",
        description: "Fast-paced action with very short cards.",
        category: "all",
        difficulty: "hard",
        ageGroup: "all",
        wordCount: 3,
        roundLength: "30s",
        tip: "No passes allowed in this high-speed mode!",
      },
    ],
    filters: {
      category: "Category",
  ...
  home: {
    ...
    siloDirectory: {
      ...
      links: [
        ...
        { href: "/family-charades-generator/", anchor: "Family Charades Generator" },
        { href: "/thanksgiving-charades-generator/", anchor: "Thanksgiving Charades Generator" },
        { href: "/halloween-charades-generator/", anchor: "Halloween Charades Generator" },
